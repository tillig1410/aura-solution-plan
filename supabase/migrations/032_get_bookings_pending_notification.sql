-- Migration 032: RPC get_bookings_pending_notification
-- Date: 2026-04-12
--
-- Returns bookings recently confirmed/cancelled by merchant that have NOT yet
-- had a notification sent. Used by booking-confirmation-notify workflow to
-- prevent duplicate WhatsApp/SMS notifications.
...
AS $$
  ...
  WHERE b.status IN ('confirmed', 'cancelled')
    ...
    AND b.source_channel != 'dashboard'
    AND NOT EXISTS (
...
GRANT EXECUTE ON FUNCTION public.get_bookings_pending_notification()
  TO service_role;
